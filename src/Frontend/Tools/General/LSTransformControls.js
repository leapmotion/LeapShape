...
class LSTransformControls extends Object3D {
	...
	constructor( camera, domElement ) {
		...
		const _gizmo = new LSTransformControlsGizmo();
		this._gizmo = _gizmo;
		this.add( _gizmo );

		const _plane = new LSTransformControlsPlane();
		this._plane = _plane;
		this.add( _plane );
...
LSTransformControls.prototype.isLSTransformControls = true;
...
class LSTransformControlsGizmo extends Object3D {
...
LSTransformControlsGizmo.prototype.isLSTransformControlsGizmo = true;

//

class LSTransformControlsPlane extends Mesh {
...
LSTransformControlsPlane.prototype.isLSTransformControlsPlane = true;
